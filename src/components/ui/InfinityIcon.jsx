const InfinityCanvas = ({color="white"}) => {
  return (
    <div className="w-full h-full rounded-full flex items-center justify-center">
      <svg className={`infinity w-[130px] h-[130px]`} xmlns="http://www.w3.org/2000/svg" width="32" height="32" fill={color} viewBox="0 0 256 256">
